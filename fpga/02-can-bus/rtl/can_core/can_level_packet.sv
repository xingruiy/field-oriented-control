//--------------------------------------------------------------------------------------------------------
// Imported verbatim from https://github.com/WangXuan95/FPGA-CAN (GPL-3.0), RTL/can_level_packet.v.
// Only change: file renamed .v -> .sv for this project's build globs. See ../../LICENSE.
//--------------------------------------------------------------------------------------------------------
