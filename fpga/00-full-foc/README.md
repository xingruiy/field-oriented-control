...
│   ├── hall/   hall_decode, hall_angle_est (PLL observer, calibrated centers)
...
| `hall`             | print observed Hall edge crossings            |
...
```
Halls ──► hall_decode ──► hall_angle_est ──► θ, ω      (calibrated centers, Np=1)
                                              │
